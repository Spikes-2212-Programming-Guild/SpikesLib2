        ...
        /**
         * A command that moves a {@link GenericSubsystem} until it reaches its target or until it can't move anymore .
         *
         * @author Yuval Levy
        ...
        public class MoveGenericSubsystem extends CommandBase {
             ...
             *                      should be moved with. Must only supply a value between -1 and 1.
             */
